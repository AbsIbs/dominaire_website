  ...
  const data = [
    {
      ...
      imageAlt: "Man Signing Adoption Papers",
    },
    {
      title: "Design",
      ...
      imageAlt: "Person Holding Papers with Drawing",
    },
    {
      title: "Deploy",
      ...
      imageAlt: "Man and Woman in front of laptop with code",
    },
  ];

  const Card = ({ title, subtitle, description, image, imageAlt }: Card) => {
    return (
